    ...
    return (
        <div>
            ...
            <Pdf targetRef={ref} filename="blog.pdf">
                {({ toPdf }) => <button className='btn my-3' onClick={toPdf}>Generate Pdf</button>}
            </Pdf>
            </div>
            <div ref={ref} className='w-10/12 lg:w-8/12 mx-auto mb-12'>
                <div className='w-[70%] mx-auto'>
                    ...
                    <div className='rounded-md drop-shadow-2xl border-2 p-6 '>
                    ...
                    <div className='rounded-md drop-shadow-2xl border-2 p-6 my-3'>
                    ...
                    <div className='rounded-md drop-shadow-2xl border-2 p-6 mb-3'>
